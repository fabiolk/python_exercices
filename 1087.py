...
while(i != 0):
    ...
    x = abs(x_lin_ini - x_lin_fi)
    y = abs(y_col_ini - y_col_fi)
    
    if (x_lin_ini + y_col_ini + x_lin_fi + y_col_fi) != 0:

        if x_lin_ini == x_lin_fi and y_col_ini == y_col_fi:
            result = 0
            print(result)
        elif x_lin_ini == x_lin_fi and y_col_ini != y_col_fi:
            result = 1
            print(result)
        elif x_lin_ini != x_lin_fi and y_col_ini == y_col_fi:
            result = 1
